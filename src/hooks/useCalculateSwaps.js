...
import { current_portfolio_total } from '../components/YourWallet'
import { Swap } from '../components/Main'


export const useCalculateSwaps = (current_percentages, goal_percentages, tokenToPriceMapping) => {
    // do some math, return object:
    // KEY: TOKEN1-TOKEN2, VALUE: number
        ...
        while (notExhausted) {
            inner: for (let index2 = 0; index2 < reversedValues.length; ++index2) {
                ...
                if (value > -j_value) {
                    ...
                    // in case tiny amount is left over (rounding error)
